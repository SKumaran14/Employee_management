...
if (request.getParameter("EmpName") != null)
{
	...
	if (request.getParameter("hidItemIDSave") == "")
	 ...
	 i=true;
		 ...
		 stsMsg =Obj.updateEmployee(request.getParameter("hidItemIDUpdate"),
...
<span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="employee.jsp">Home</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="empReview.jsp"> Edit</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
<div class="container">
 ...
 <div class="col">
  ...
  Employee Name: <input name="EmpName" type="text"  class="form-control" required><br>
 Employee Type: <input name="EmpType" type="text"  class="form-control" required><br>
 Employee PhoneNumer: <input name="EmpPhone" type="text"  class="form-control" required><br>
 Employee Email: <input name="EmpEmail" type="text"  class="form-control" required><br>
 Employee Password: <input name="EmpPassword" type="password"  class="form-control" required><br>
